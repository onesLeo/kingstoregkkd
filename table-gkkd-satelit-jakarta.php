                        ...
                        <section class="panel">
                            ...
                            <div class="panel-body">
                                ...
                                <table id="inf_barang" class="table table-striped table-advance table-hover">
                                    <thead>
                                    <tr>
                                        <th><i class=""></i> Nama Satelit</th>
                                        <th><i class=""></i> Alamat Satelit</th>
        ...
        $(document).ready(function () {
            ...
            function fetch_data() {
                var dataTable = $('#inf_barang').DataTable({
                    ...
                    "order": [],
                    "ajax": {
                        url: "scripts/gkkd-satelit/fetch-gkkdsatelit.php",
                        type: "POST"
                    }
                });
            }
            ...
            function update_data(id, column_name, value) {
                $.ajax({
                    url: "scripts/gkkd-satelit/update-inf-gkkdsatelit.php",
                    method: "POST",
            ...
            $(document).on('click', '.delete', function () {
                ...
                if (confirm("Are you sure you want to remove this?")) {
                    $.ajax({
                        url: "scripts/gkkd-satelit/delete-inf-gkkdsatelit.php",
                        method: "POST",
                        data: {id: id},
                        success: function (data) {
                            $('#alert_message').html('<div class="alert alert-success">' + data + '</div>');
