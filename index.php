                            ...
                            <div class="panel-body">
                                <div class="form">
                                    <form class="form-validate form-horizontal "
                                          action="scripts/save_informasi_pembelian.php" id="form_pembelian"
                                          method="post">
                                        <div class="form-group ">
                                            <label for="npembeli" class="control-label col-lg-2">Nama Pembeli
                                                <span class="required">*</span></label>
                                            <div class="col-lg-10">
                                                <input class=" form-control" id="npembeli" name="npembeli"
                                                       type="text"/>
                                            </div>
                                        </div>
                                        <div class="form-group ">
                                            <label for="noktp" class="control-label col-lg-2">No KTP
                                                <span class="required">*</span></label>
                                            <div class="col-lg-10">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-10">
                                                ...
                                                <select id="pbarang" name="pbarang" data-live-search=true
                                                        class="form-control selectpicker input-sm m-bot15">
                                                    ...
                                                    while ($rows = mysqli_fetch_assoc($result)) {
                                                        ?>
                                                        <option value="<?php echo $rows["id_informasi_barang"] ?>"
                                                                data-token="<?php echo $rows["nama_barang"] ?>"> <?php echo $rows["nama_barang"] ?> </option>
                                                    <?php } ?>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="form-group ">
                                            <label for="fullname" class="control-label col-lg-2">Qty tersedia <span
                                                        class="required"></span></label>
                                            <div class="col-lg-10">
                                                <input class=" form-control" id="idbarang" name="idbarang"
                                                       type="hidden"/>
                                                <input class=" form-control" id="qtytersedia" readonly
                                                       name="qtytersedia" type="text"/>
                                            </div>
                                        </div>

                                        <div class="form-group ">
                                            <label for="fullname" class="control-label col-lg-2">Harga per barang <span
                                                        class="required"></span></label>
                                            <div class="col-lg-10">
                                                <input class=" form-control" disabled=true id="hpbarang" name="hpbarang"
                                                       type="text"/>
                                            </div>
                                        </div>
                                        <div class="form-group ">
                                            <label for="jpembelian" class="control-label col-lg-2">Jumlah pembelian
                                                <span class="required">*</span></label>
                                            <div class="col-lg-10">
                                                <input class=" form-control" id="jpembelian" name="jpembelian"
                                                       type="text"/>
                                            </div>
                                        </div>
                                        <div class="form-group ">
                                            <label for="fullname" class="control-label col-lg-2">Total Harga <span
                                                        class="required"></span></label>
                                            <div class="col-lg-10">
                                                <input class=" form-control" readonly id="tharga" name="tharga"
                                                       type="text"/>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label col-lg-2" for="gkkdsatelit">Pilih Tempat
                                                Pengiriman</label>
                                            <div class="col-lg-10">

                                                <select id="gkkdsatelit" name="gkkdsatelit" data-live-search=true
                                                        class="form-control selectpicker input-sm m-bot15">
                                                    <option value="" data-token="">----</option>
                                                    <?php
                                                    ...
                                                    while ($rows = mysqli_fetch_assoc($result)) {
                                                        ?>
                                                        <option value="<?php echo $rows["id_gkkd_satelit_jakarta"] ?>"
                                                                data-token="<?php echo $rows["nama_satelit"] ?>"> <?php echo $rows["nama_satelit"] ?> </option>
                                                    <?php } ?>
                                                </select>
                                                <input class=" form-control" id="namasatelit" name="namasatelit"
                                                       type="hidden"/>
                                            </div>
                                        </div>
                                        <div class="form-group">
